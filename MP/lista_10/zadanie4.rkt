...
(define (cond->if [cs : (Listof (Exp * Exp))]) : ExpUnSugared
...
(define (un-sugar [s : Exp]) : ExpUnSugared
  (type-case Exp s
    [(numE x) (numUs x)]
    [(ifE b x y)
     (ifUs (un-sugar b)
...
(define (eval [e : ExpUnSugared]) : Value
  (type-case ExpUnSugared e
    [(numUs n) (numV n)]
    [(opUs o l r) ((op->proc o) (eval l) (eval r))]
    [(ifUs b l r)
